...
const DinningOrderChart = ({ ordersData }) => {
  ...
  useEffect(() => {
    ...
    if (chartData.labels && chartData.labels.length > 0) {
      const ctx = document
        .getElementById("dinningordersChart")
        .getContext("2d");
  ...
  return (
    <div>
     ...
     {chartData?.labels?.length === 0 ? (
        ...
        <canvas id="dinningordersChart" width="400" height="200"></canvas>
      )}
...
export default DinningOrderChart;
